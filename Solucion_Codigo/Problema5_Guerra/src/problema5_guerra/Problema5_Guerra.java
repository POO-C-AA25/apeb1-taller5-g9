...
class Conflicto {
    ...
    public String toString() {
        return "Conflicto{" + "nombre = " + nombre + ", fechaInicio = " + fechaInicio
                + ", estadoActual = " + estadoActual + ", totalPaisesMundo = " + totalPaisesMundo
                + ", eventos = " + eventos + '}';
    }
